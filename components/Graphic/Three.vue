<template>
  ...
  <div class="flex h-20 items-center gap-10 px-20">
    ...
    <div class="h-1 w-full bg-gradient-to-r from-rp-iris"></div>
  </div>
  <div class="h-20 w-full"></div>
</template>
<style scoped>
