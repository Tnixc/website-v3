<template>
  <div class="mb-2 w-full rounded-b-6xl bg-rpd-base" id="title">
    <div class="px-6 pb-20 pt-20 font-serif text-rp-text lg:px-20">
      ...
      <p class="pb-4 pt-16 font-sans text-xl leading-7 text-rp-subtle">
        ...
        UI/UX design, but I'm not sure yet.
      </p>
    </div>
  </div>
  <div>
    ...
    ></div>
    <div
      class="flex justify-center rounded-b-6xl bg-gradient-to-t from-rp-highlightLow via-rp-base to-rp-base py-20"
    >
      <div class="flex w-fit flex-wrap justify-around gap-4">
        <div
